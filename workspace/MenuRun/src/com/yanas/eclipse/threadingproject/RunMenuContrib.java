...
public class RunMenuContrib implements org.eclipse.core.commands.IHandler {
	
	public RunMenuContrib() {
...
//	    	      (ThreadingView)event.getApplicationContext(),"Readme Editor","View Action executed");
		...
		ThreadingView.myThreadingView.label.setText( "Start: "+ fibStart +" Fibonacci set prior: " + 
