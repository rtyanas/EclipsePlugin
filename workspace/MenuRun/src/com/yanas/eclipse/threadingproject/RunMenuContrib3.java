...
public class RunMenuContrib3 implements org.eclipse.core.commands.IHandler {
	
	public RunMenuContrib3() {
...
//	    	      (ThreadingView)event.getApplicationContext(),"Readme Editor","View Action executed");
		...
		ThreadingView.myThreadingView.label3.setText( "Start: "+ fibStart +" Fibonacci set prior: " + 
